    ...
    questions: [
      {
        ...
        answer:
          "Navigate to Settings > Profile and fill in your restaurant details including name, address, contact information, and operating hours.",
      },
      {
        question: "How do I add my first menu items?",
        answer:
          "Go to Items > Catalog > Create to add new menu items. Include name, price, category, description, and an image for best results.",
      },
      {
        question: "How do I configure payment methods?",
        answer:
          "Visit Payments > Methods to enable and configure available payment options like credit cards, digital wallets, and cash payments.",
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        answer:
          "Go to Orders > List to see all current and past orders. Orders are automatically sorted by status and time.",
      },
      {
        question: "How do I update order status?",
        answer:
          "1. Open an order from Orders > List\n2. Use the status dropdown to change from 'Pending' to 'Preparing', 'Ready', or 'Completed'\n3. Add notes if needed",
      },
      {
        question: "How do I handle special requests?",
        answer:
          "Special instructions appear prominently in the order details. Review them carefully before preparing food and note any allergies or modifications.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Go to QR > Tables to view all generated QR codes. You can edit descriptions, regenerate, or deactivate codes as needed.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Go to Inventory > List to view current stock levels, low stock alerts, and usage trends.",
      },
      {
    ...
    questions: [
      {
        ...
        answer:
          "Go to Security > Password and enter your current password, then set a new secure password.",
      },
      {
        question: "How do I manage user roles?",
        answer:
          "Go to Security > Users to add staff members and assign roles like Manager, Chef, or Server with appropriate permissions.",
      },
      {
        question: "How do I update restaurant settings?",
        answer:
          "Visit Settings > General to update restaurant information, operating hours, and system preferences.",
      },
    ],
  },
];
...
export default function HelpPage() {
  return (
    <Box sx={{ p: 3 }}>
      <Breadcrumb
        items={[{ label: "Home", href: "/home" }, { label: "Help" }]}
      />
      ...
      <Box sx={{ textAlign: "center", mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          Find answers to common questions and learn how to use all features of
      ...
      <Box sx={{ mt: 4, textAlign: "center" }}>
        <Paper
          sx={{ p: 3, bgcolor: "primary.light", color: "primary.contrastText" }}
        >
          <Typography variant="h6" gutterBottom>
            Still need help?
          </Typography>
          <Typography variant="body2">
            Contact our support team at support@restaurantapp.com or call
            1-800-RESTAURANT
          </Typography>
        </Paper>
      </Box>
