...
export default function PaymentPage({ cart, totalAmount, onPaymentSuccess, onBack }: PaymentPageProps) {
  ...
  return (
    <Box sx={{ maxWidth: 800, mx: 'auto', p: { xs: 2, sm: 3 } }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
        <Button onClick={onBack} disabled={activeStep === 2} sx={{ color: '#666666' }}>
          ← Back
        </Button>
      ...
      <Stepper activeStep={activeStep} alternativeLabel sx={{ mb: 4 }}>
        {steps.map((label) => (
          <Step key={label}>
            <StepLabel sx={{ '& .MuiStepLabel-label': { color: '#666666' } }}>{label}</StepLabel>
          </Step>
        ))}
      </Stepper>
      ...
      {activeStep === 0 && (
        ...
        >
          <Paper sx={{ p: 3, backgroundColor: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: 1 }}>
            <Typography variant="h6" sx={{ mb: 2, fontWeight: 600, color: '#111111' }}>
              Order Summary
            </Typography>
            ...
            <Box sx={{ mb: 3 }}>
              {cart.map((item) => (
                ...
                >
                  ...
                  <Typography variant="body2" fontWeight={500} sx={{ color: '#111111' }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
              <Typography variant="body2" sx={{ color: '#666666' }}>Subtotal</Typography>
              <Typography variant="body2" sx={{ color: '#111111' }}>₹{totalAmount.toFixed(2)}</Typography>
            </Box>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
              <Typography variant="body2" sx={{ color: '#666666' }}>Tax (10%)</Typography>
        ...
        >
          <Paper sx={{ p: 3, backgroundColor: '#FFFFFF', border: '1px solid #E5E7EB', borderRadius: 1 }}>
              ...
              >
                ...
                >
                  <FormControlLabel
                    ...
                    sx={{ width: '100%' }}
                  />
                  <Typography variant="body2" sx={{ color: '#666666', ml: 6, mt: -1 }}>
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Typography fontWeight={500} sx={{ color: '#9CA3AF' }}>UPI Payment</Typography>
                      </Box>
                    }
                    sx={{ width: '100%' }}
                  />
                  ...
                  <FormControlLabel
                    ...
                    label={
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        ...
                        <Typography fontWeight={500} sx={{ color: '#9CA3AF' }}>Card Payment</Typography>
                      </Box>
                    }
                    sx={{ width: '100%' }}
                  />
            ...
            {paymentMethod === 'upi' && (
              ...
              >
                <Typography variant="subtitle2" sx={{ mb: 2, color: '#111111' }}>
                  Scan to Pay via UPI
                </Typography>
                ...
                <Alert severity="info" sx={{ mt: 2, width: '100%', borderRadius: 1, backgroundColor: '#EFF6FF', color: '#1E40AF' }}>
      ...
      {activeStep === 2 && (
        ...
        >
          ...
          >
            ...
            <Typography variant="h5" sx={{ mb: 1, fontWeight: 600, color: '#111111' }}>
              Payment Successful!
            </Typography>
            ...
            <Box sx={{ display: 'flex', gap: 2, justifyContent: 'center' }}>
              <Button 
                variant="outlined" 
                startIcon={<Receipt />}
                sx={{ borderRadius: 1, borderColor: '#E5E7EB', color: '#666666' }}
              >
                View Receipt
              </Button>
              <Button 
