...
import { Search, CheckCircle, Schedule, LocalShipping, Restaurant, DoneAll } from '@mui/icons-material';
  ...
  return (
    <Box sx={{ maxWidth: 600, mx: 'auto', p: 2 }}>
      ...
      >
        <Box sx={{ display: 'flex', gap: 2 }}>
          ...
          <Button
            ...
            sx={{ px: 4 }}
          >
            {isLoading ? <CircularProgress size={24} color="inherit" /> : 'Track'}
          </Button>
        </Box>
      ...
      {order && (
        ...
        >
          <Card sx={{ backgroundColor: 'var(--surface)', border: '1px solid var(--border)' }}>
            <CardContent>
              {/* Order Header */}
                            ...
                            sx={{
                              ...
                              backgroundColor:
                                index <= getActiveStep()
                                  ? 'var(--primary)'
                                  : 'var(--surface-hover)',
                              color: index <= getActiveStep() ? '#fff' : 'text.secondary',
                            }}
                          >
